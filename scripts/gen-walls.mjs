...
const CAPTIONS = {
  ...
  "salt-lake-city": { "hero-aerial": "The Wasatch right off downtown. Still can't believe it.", "seasonal-winter": "Greatest Snow on Earth is not just a slogan.", "seasonal-summer": "Canyon hiking, then a global dinner on State Street.", "seasonal-spring": "Snow up top, blossoms in the valley. Same day.", "seasonal-fall": "Aspen gold in the Cottonwoods.", "downtown-temple-square": "Temple Square, then State Street for dumplings.", "canyon-ski": "First chair in the Cottonwoods. Canyon traffic was worth it.", "district-sugar-house": "Sugar House afternoon — indie shops, mountain air." },
